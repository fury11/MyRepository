...
<div id="content" style="margin-top: -10px">
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
        <li><a href="Print">Print Local</a></li>
        <li class="active"><a href="PrintAll">Print All</a></li>
    </ul>
</div>
<div style="margin: 20px 0 20px 0">
<form:form action="PrintAll" method="get" modelAttribute="PrintAllModel">
...
<tbody>
<c:forEach items="${printAllList}" var="p">
<tr>
...
<hr>
<a href="" class="btn btn-success btn-lg"><i class="fa fa-print"></i> PRINT RECORDS</a>&nbsp;&nbsp;
